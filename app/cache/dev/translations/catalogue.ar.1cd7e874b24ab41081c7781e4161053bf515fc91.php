...
$catalogue = new MessageCatalogue('ar', array (
  ...
  array (
    ...
    'The password fields must match' => 'يجب ان تتطابق كلمه المرور',
    'Your username must be at least 5 characters long' => 'لابد اسم المستخدم يتكون على الاقل من 5 حروف',
    'Your username cannot be longer than 15 characters' => 'لابد اسم المستخدم لا يتعدى 15 حرف',
    'The email  is not a valid email' => 'الايميل الذى ادخلته غير صحيح',
    'The facebook url  is not a valid url' => 'الفيس بوك الذى ادخلته غير صحيح',
    'The twitter url  is not a valid url' => 'حساب التوتير الذى ادخلته غير صحيح',
    'The linkedin url  is not a valid url' => 'حساب اللينكدان غير صحيح',
    'The youtube url  is not a valid url' => 'حساب اليوتيوب غير صحيح',
    'Please upload a valid image' => 'من فضللك ادخل الصورة الصحيحه',
  ),
  'security' => 
  array (
  ...
  array (
    ...
    'add new category' => 'اضيف قسم جديد',
    'please enter your category' => 'من فضلك ادخل اسم القسم',
    'your category has been added sucessfully' => 'لقد تم اضافه القسم بنجاح',
    'Edit Category' => 'تعديل القسم',
    'your category has been edited sucessfully' => 'لقد تم تعديل القسم بنجاح',
    'Delete category' => 'حذف قسم',
    'do u want to delete this category???' => 'هل تود حذف هذا القسم ؟؟؟',
    'your category has been deleted sucessfully' => 'لقد تم حذف هذا القسم بنجاح',
  ),
  'user' => 
  array (
    'user' => 'المستخدمين',
    'please enter your name' => 'من فضللك ادخل اسم المستخدم',
    'please enter your email' => 'من فضللك ادخل الايميل الخاص بك',
    'please enter your FB' => 'من فضللك ادخل facebook',
    'please enter your twitter' => 'من فضللك ادخل twitter',
    'please enter your google plus' => 'من فضللك ادخل googleplus',
    'please enter your linkedin' => 'من فضللك ادخل linkedin',
    'please enter your youtube' => 'من فضللك ادخل youtube',
    'edit user' => 'تعديل المستخدم',
    'your user has been edited sucessfully' => 'لقد تم تعديل المستخدم بنجاح',
  ),
  'public' => 
  array (
    'name' => 'الاسم',
    ...
    'Repeat Password' => 'اعاده كلمه المرور',
    'email' => 'الايميل',
    'image' => 'الصورة',
    'date' => 'التاريخ',
    'logout' => 'خروج',
    'dashboard' => 'لوحه التحكم الرئيسيه',
    'language' => 'اللغه',
    'link' => 'الرابط الالكترونى',
    'description' => 'التفاصيل',
    'POST COMMENT' => 'حفظ تعليق',
    'add comment' => 'اضافه تعليق',
    'comments' => 'التعليقات',
    'main' => 'الرئيسيه',
  ),
  'article' => 
  array (
    ...
    'article description' => 'تفاصيل المقال',
    'add new article' => 'اضيف مقال جديد',
    'please enter your article name' => 'من فضللك ادخل اسم المقال',
    'please enter your article description' => 'من فضللك ادخل تفاصيل المقال',
    'your article has been added sucessfully' => 'لقد تم اضافه القسم بنجاح',
    'edit article' => 'تعديل المقال',
    'your article has been edited sucessfully' => 'لقد تم تعديل المقال بنجاح',
    'delete article' => 'حذف المقال',
    'do u want to delete this article???' => 'هل تود حذف هذا المقال؟؟؟',
    'your article has been deleted sucessfully' => 'لقد تم حذف هذا المقال بنجاح',
  ),
));
